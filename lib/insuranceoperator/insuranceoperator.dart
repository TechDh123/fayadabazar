...
class InsuranceOperator extends StatefulWidget {
  const InsuranceOperator({super.key});

  @override
  State<InsuranceOperator> createState() => _InsuranceOperatorState();
}

class _InsuranceOperatorState extends State<InsuranceOperator> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Insurance",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),),
      ),
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
