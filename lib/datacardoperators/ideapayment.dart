...
class IdeaPayment extends StatefulWidget {
  const IdeaPayment({super.key});

  @override
  State<IdeaPayment> createState() => _IdeaPaymentState();
}

class _IdeaPaymentState extends State<IdeaPayment> {
  @override
