...
class IdeaInsertion extends StatefulWidget {
  const IdeaInsertion({super.key});

  @override
  State<IdeaInsertion> createState() => _IdeaInsertionState();
}

class _IdeaInsertionState extends State<IdeaInsertion> {
  @override
