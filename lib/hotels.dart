...
class _HotelsState extends State<Hotels> {
  ...
  List<Map<String, String>> imageList = [
    {"id": "1", "image_path": 'assets/images/25.png'},
    {"id": "2", "image_path": 'assets/images/25.png'},
    {"id": "3", "image_path": 'assets/images/26.png'},
    {"id": "4", "image_path": 'assets/images/fastfood.png'},
    {"id": "5", "image_path": 'assets/images/icecream.png'},
  ];
                  ...
                  Expanded(
                    child: TextField(
                      decoration: InputDecoration(
                        hintText: 'Search for restaurant, cuisine or more',
          ...
          child: Column(
            children:  [
              ...
              Row(
                ...
                children: [
                  SizedBox(width: 10,),
                  Text("Finest restaurants with unbeatable deals",style: TextStyle(color: Colors.black,fontSize: 11),),
                  Spacer(),
                  GestureDetector(
                    child: Padding(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => Hotelsdiscounts()),
                      );
                    },
                  ),
                ],
                  ...
                  children: [
                    Expanded(
                      child: Padding(
                        ...
                        child: Text("Explore 1000 restaurants around you",
                          style: TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 23
                          ),
...
List<String> topCategoriesImages = [
  'assets/images/newr2.png',
  'assets/images/newr.png',
  'assets/images/newr3.png',
];
