...
class SellYourAnimal extends StatefulWidget {
  const SellYourAnimal({Key? key}) : super(key: key);

  @override
  _SellYourAnimalState createState() => _SellYourAnimalState();
}
...
class _SellYourAnimalState extends State<SellYourAnimal> {
  ...
  final List<String> animalTypes = ['Cow', 'Goat', 'Sheep', 'Horse', 'Chicken'];
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                _buildDropdownFormField('Animal Type', animalTypes, (value) => setState(() => animalType = value), icon: Icons.pets),
                const SizedBox(height: 12),
                _buildTextField('Animal Age (in years)', (value) {
                  if (value == null || value.isEmpty) {
                    return 'Please enter the animal\'s age';
                  }
                  return null;
                }, (value) => animalAge = value, keyboardType: TextInputType.number, icon: Icons.access_time),
                const SizedBox(height: 12),
                _buildTextField('Animal Weight (in kg)', (value) {
                  if (value == null || value.isEmpty) {
                    return 'Please enter the animal\'s weight';
                  }
                  return null;
                }, (value) => animalWeight = value, keyboardType: TextInputType.number, icon: Icons.fitness_center),
                const SizedBox(height: 12),
